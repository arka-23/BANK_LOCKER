# BANK_LOCKER
This repository contains a simple Digital Lock design for a logic circuit(combinational and sequential) based digital bank locker opener with three buttons,1,2 and R.
